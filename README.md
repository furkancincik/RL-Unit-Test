...
- Untyped inference is limited to primitive parameter evidence. Custom-object synthesis, collection-state or element-schema inference, and ambiguous runtime-dependent typing remain unsupported.
